    ...
    <>
      <Head>
        ...
        <link rel="icon" href="/favicon.ico" />
          ...
          <Link href="/">
            <button type="button" className="ml-4 mt-4 text-gray-900 bg-white border border-gray-300 focus:outline-none hover:bg-gray-100 focus:ring-4 focus:ring-gray-200 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2">Back to Timeline</button>
          </Link>
